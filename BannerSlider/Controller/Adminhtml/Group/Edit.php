...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('PHPCuong\BannerSlider\Model\Group');
        ...
        $resultPage->setActiveMenu(
            'PHPCuong_BannerSlider::all_banners'
        )->addBreadcrumb(
    ...
    {
        return $this->_authorization->isAllowed('PHPCuong_BannerSlider::group_read') ||
        $this->_authorization->isAllowed('PHPCuong_BannerSlider::group_create');
    }
}
